...
def run():
    ...
    while True:
        # Когда сервер что-то принял от клиента
        # возвращает сокет и адрес клиента
        client_socket, addr = server_socket.accept()

        # Сам запрос от клиента
        # принимает кол-во байт в пакете
        # возвращает запрос в bytes
